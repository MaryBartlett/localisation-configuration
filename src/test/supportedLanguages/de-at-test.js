...
describe('de-at language test', function () {
    ...
    it('should have correct pluralization rules', function () {
        expect(configuredLocaliser._i18n.pluralization["de-AT"](0)).toEqual(["other"]);
        expect(configuredLocaliser._i18n.pluralization["de-AT"](1)).toEqual(["one"]);
        expect(configuredLocaliser._i18n.pluralization["de-AT"](2)).toEqual(["other"]);
    });
