...
describe('en-ae language test', function () {
    ...
    it('should have correct pluralization rules', function () {
        expect(configuredLocaliser._i18n.pluralization["en-AE"](0)).toEqual(["other"]);
        expect(configuredLocaliser._i18n.pluralization["en-AE"](1)).toEqual(["one"]);
        expect(configuredLocaliser._i18n.pluralization["en-AE"](2)).toEqual(["other"]);
    });
