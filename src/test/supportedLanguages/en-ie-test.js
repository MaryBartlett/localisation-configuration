...
describe('en-ie language test', function () {
    ...
    it('should have correct pluralization rules', function () {
        expect(configuredLocaliser._i18n.pluralization["en-IE"](0)).toEqual(["other"]);
        expect(configuredLocaliser._i18n.pluralization["en-IE"](1)).toEqual(["one"]);
        expect(configuredLocaliser._i18n.pluralization["en-IE"](2)).toEqual(["other"]);
    });
