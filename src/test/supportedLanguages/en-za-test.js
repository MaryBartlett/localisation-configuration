...
describe('language-territory language test', function () {
    ...
    it('should have correct pluralization rules', function () {
        expect(configuredLocaliser._i18n.pluralization["en-ZA"](0)).toEqual(["other"]);
        expect(configuredLocaliser._i18n.pluralization["en-ZA"](1)).toEqual(["one"]);
        expect(configuredLocaliser._i18n.pluralization["en-ZA"](2)).toEqual(["other"]);
    });
