...
describe('en language test', function () {
    ...
    it('should have correct pluralization rules', function () {
        expect(config.supportedLanguages.en.pluralization).toBeFunction();
        expect(config.supportedLanguages.en.pluralization(0)).toEqual(["other"]);
        expect(config.supportedLanguages.en.pluralization(1)).toEqual(["one"]);
        expect(config.supportedLanguages.en.pluralization(2)).toEqual(["other"]);

        expect(configuredLocaliser._i18n.pluralization["en-GB"](0)).toEqual(["other"]);
        expect(configuredLocaliser._i18n.pluralization["en-GB"](1)).toEqual(["one"]);
        expect(configuredLocaliser._i18n.pluralization["en-GB"](2)).toEqual(["other"]);
    });
