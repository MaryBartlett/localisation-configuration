...
describe('en-in language test', function () {
    ...
    it('should have correct pluralization rules', function () {
        expect(configuredLocaliser._i18n.pluralization["en-IN"](0)).toEqual(["other"]);
        expect(configuredLocaliser._i18n.pluralization["en-IN"](1)).toEqual(["one"]);
        expect(configuredLocaliser._i18n.pluralization["en-IN"](2)).toEqual(["other"]);
    });
