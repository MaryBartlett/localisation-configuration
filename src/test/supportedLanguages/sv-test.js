...
describe('sv language test', function () {
    ...
    it('should have correct pluralization rules', function () {
        expect(config.supportedLanguages.sv.pluralization).toBeFunction();
        expect(config.supportedLanguages.sv.pluralization(0)).toEqual(["other"]);
        expect(config.supportedLanguages.sv.pluralization(1)).toEqual(["one"]);
        expect(config.supportedLanguages.sv.pluralization(2)).toEqual(["other"]);

        expect(configuredLocaliser._i18n.pluralization["sv-SE"](0)).toEqual(["other"]);
        expect(configuredLocaliser._i18n.pluralization["sv-SE"](1)).toEqual(["one"]);
        expect(configuredLocaliser._i18n.pluralization["sv-SE"](2)).toEqual(["other"]);
    });
