...
describe('pt-br language test', function () {
    ...
    it('should have correct pluralization rules', function () {
        expect(configuredLocaliser._i18n.pluralization["pt-BR"](0)).toEqual(["other"]);
        expect(configuredLocaliser._i18n.pluralization["pt-BR"](1)).toEqual(["one"]);
        expect(configuredLocaliser._i18n.pluralization["pt-BR"](2)).toEqual(["other"]);
    });
