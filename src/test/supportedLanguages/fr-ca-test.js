...
describe('fr-ca language test', function () {
    ...
    it('should have correct pluralization rules', function () {
        expect(configuredLocaliser._i18n.pluralization["fr-CA"](0)).toEqual(["other"]);
        expect(configuredLocaliser._i18n.pluralization["fr-CA"](1)).toEqual(["one"]);
        expect(configuredLocaliser._i18n.pluralization["fr-CA"](2)).toEqual(["other"]);
    });
